						...
						<div class="keep">
							<header id="header">
								<div class="bg-primary hero-logo">
									<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() . '/img/PriestSheetMetal&PlateChristchurch-white-600x149.png'; ?>" alt="<?php bloginfo ('name') ?>"></a>
								</div><!-- .grid-x -->
